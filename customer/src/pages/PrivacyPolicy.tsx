    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-4 py-6 space-y-6 text-gray-800">
        ...
        <section>
          ...
          <p className="text-sm leading-relaxed mb-2">We collect information to provide and improve our Services:</p>
        ...
        <section>
          ...
          <p className="text-sm leading-relaxed mb-2">We use the information we collect for the following purposes:</p>
          <div className="text-sm leading-relaxed space-y-2">
        ...
        <section>
          <h2 className="text-lg font-bold mb-2">3. Information Sharing and Disclosure</h2>
          <p className="text-sm leading-relaxed mb-2">We do not sell your personal data. We may share your information in the following limited circumstances:</p>
          <div className="text-sm leading-relaxed space-y-2">
        ...
        <section>
          <h2 className="text-lg font-bold mb-2">4. Cookie Policy</h2>
          <div className="text-sm leading-relaxed space-y-2">
            <p>a) <strong>What are Cookies?</strong> Cookies are small text files stored on your device when you use our App. They help us remember your preferences and understand how you use our Services.</p>
            <p>b) <strong>Why We Use Cookies:</strong> We use cookies for essential functions like user authentication, session management, and to remember your login details. We also use analytical cookies to understand user behavior and improve our App's performance.</p>
            <p>c) <strong>Your Control:</strong> Most devices allow you to disable cookies through your settings. However, disabling essential cookies may affect the core functionality of the App.</p>
          </div>
        </section>
        ...
        <section>
          ...
          <p className="text-sm font-semibold mt-2">Email: support@urbansteam.in</p>
        </section>
      </div>
    </div>
  );
