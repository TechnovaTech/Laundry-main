...
const Booking = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20 sm:pb-24">
      ...
      <header className="bg-white px-4 sm:px-6 flex items-center justify-between shadow-sm" style={{ paddingTop: 'calc(1rem + env(safe-area-inset-top))', paddingBottom: '1rem' }}>
